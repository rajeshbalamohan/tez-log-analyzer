 ...
 */
public class LaunchContainerInfoExtractor extends BaseAnalyzer {

  private StringBuilder sb = new StringBuilder();

  private static final String STARTING = "LogType:launch_container.sh";
  private static final String ENDING = "End of LogType:launch_container.sh";
